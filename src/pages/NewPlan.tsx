...
const initialForm: TripPlanInput = {
  title: "",
  artist: "",
  date: today,
  city: "",
...
export const NewPlan = ({ onCreate }: NewPlanProps) => {
  const [form, setForm] = useState<TripPlanInput>(initialForm);
    ...
    <form onSubmit={handleSubmit} className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-normal">新建远征计划</h1>
        </div>
        <button
          type="submit"
